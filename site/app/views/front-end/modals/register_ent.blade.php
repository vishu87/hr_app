		...
		<div class="modal-body">
			...
			<div class="popup">
				...
				<form name="registerForm" novalidate="novalidate" ng-submit="onSubmit(registerForm.$valid)" ng-show="true">
					...
					<div class="form-group">
						{{Form::text('company_name','',["class"=>"form-control",'placeholder'=>'Company Name', 'ng-model' => 'registerData.company_name'])}}
						<span class="red-asterik">{{$errors->first('company_name')}}</span>
					</div>
					<div class="form-group">
